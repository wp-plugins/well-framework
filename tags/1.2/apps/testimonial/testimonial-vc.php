...
if(function_exists('vc_map')):
	vc_map( array(
		"name" => __("Testimonial [Grid]", 'well_textdomain'),
		"base" => "well_testimonial_grid",
		"class" => "",
		...
		"params" => array(
			...
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => __("Testimonials Category", 'well_textdomain'),
				"param_name" => "cat",
				"value" => '',
				"taxonomy" => 'portwell_cat',
				"description" => __("Select a Category to display testimonial items form that category", "well_textdomain")
			),
			array(
				"type" => "dropdown",
				"holder" => "div",
				...
				"description" => __('Select No if you select a category to display testimonial items', "well_textdomain")
			),
			array(
				"type" => "textfield",
				"holder" => "div",
				"class" => "",
				"heading" => __("Testimonial limit"),
				"param_name" => "limit",
				"value" => '9',
				"description" => ""
			),
	...
	vc_map( array(
		"name" => __("Testimonial [Slideshow]", 'well_textdomain'),
		"base" => "well_testimonial_slideshow",
		"class" => "",
		"category" => __('Content', 'well_textdomain'),
		//'admin_enqueue_js' => array(get_template_directory_uri().'/vc_extend/bartag.js'),
		//'admin_enqueue_css' => array(get_template_directory_uri().'/vc_extend/bartag.css'),
		"params" => array(
			...
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => __("Testimonial Category", 'well_textdomain'),
				"param_name" => "cat",
				"value" => '',
				"taxonomy" => 'portwell_cat',
				"description" => __("Select a Category to display Testimonial items form that category", "well_textdomain")
	...
	vc_map( array(
		"name" => __("Testimonial [carousel]", 'well_textdomain'),
		"base" => "well_testimonial_carousel",
		"class" => "",
		"category" => __('Content', 'well_textdomain'),
		//'admin_enqueue_js' => array(get_template_directory_uri().'/vc_extend/bartag.js'),
		//'admin_enqueue_css' => array(get_template_directory_uri().'/vc_extend/bartag.css'),
