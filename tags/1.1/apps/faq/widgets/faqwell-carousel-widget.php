<?php
if (!class_exists('faqwell_carousel_widget') && class_exists( 'WPH_Widget_Mod' )) {
	class faqwell_carousel_widget extends WPH_Widget_Mod{
		function __construct(){
			$args = array( 
				'slug' => 'faqwell_carousel_widget', 	
	...
	if (!function_exists('faqwell_carousel_register_widget')){
		function faqwell_carousel_register_widget(){
			register_widget( 'faqwell_carousel_widget' );
		}
		add_action( 'widgets_init', 'faqwell_carousel_register_widget', 1 );
	}
}