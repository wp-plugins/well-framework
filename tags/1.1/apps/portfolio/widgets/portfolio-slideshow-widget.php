<?php
if (!class_exists('portwell_slideshow_widget') && class_exists( 'WPH_Widget_Mod' )) {
	class portwell_slideshow_widget extends WPH_Widget_Mod{
		function __construct(){
			$args = array( 
				'slug' => 'portwell_slideshow_widget', 	
	...
	if (!function_exists('portwell_slideshow_register_widget')){
		function portwell_slideshow_register_widget(){
			register_widget( 'portwell_slideshow_widget' );
		}
		add_action( 'widgets_init', 'portwell_slideshow_register_widget', 1 );
	}
}